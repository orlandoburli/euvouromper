...
<body class="metro" style="">
	...
	<div class="container" style="padding: 10px">
		<div class="metro one-column">
			...
			<h2 class="titles-big title-noticias">Agenda</h2>

			<c:forEach items="${agendas}" var="agenda">

				<a href="${root}/agenda/${agenda.url}" title="" class="article-lista-noticias">
					<article class="">
						<aside class="span1 data-noticias left">
							<fmt:formatDate value="${agenda.data.time}" pattern="dd" var="diaNoticia" />
							<fmt:formatDate value="${agenda.data.time}" pattern="MMM" var="mesNoticia" />
