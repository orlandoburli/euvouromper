...
<div class="panel panel-default panel-body">
	...
	<div class="panel-body">
		<div class="DataGridConsulta" data-page="mensagemconsulta.grid.admin" data-page-size="8" data-detail-page="mensagemcadastro.admin"></div>

		<c:if test="${usuario.perfil.permissaoMensagemAlt eq 'S'}">
