...
<div class="panel panel-default panel-body">
	...
	<div class="panel-body">
		<div class="DataGridConsulta" data-page="cupomdescontoconsulta.grid.admin" data-page-size="8" data-detail-page="cupomdescontocadastro.admin"></div>

		<c:if test="${usuario.perfil.permissaoCupomAlt eq 'S'}">
