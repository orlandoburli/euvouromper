			...
			<div class="form-group">
				...
				<div class="col-sm-7">
					<div class="input-group">
						<input id="chave" type="text" value="${vo.chave}" autofocus="autofocus" class="form-control" maxlength="20"/>
						<span class="input-group-btn">
							<button class="btn btn-default ButtonGerarChave" type="button"><i class="icon-share3"></i> Gerar chave aleatória&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button>
						</span>
