...
<div class="panel panel-default panel-body">
	...
	<div class="panel-body">
		<div class="DataGridConsulta" data-page="emailconsulta.grid.admin" data-page-size="8" data-detail-page="emailcadastro.admin"></div>

		<c:if test="${usuario.perfil.permissaoEmailAlt eq 'S'}">
