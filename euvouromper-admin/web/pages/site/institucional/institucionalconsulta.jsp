...
<div class="panel panel-default panel-body">
	...
	<div class="panel-body">
		<div class="DataGridConsulta" data-page="institucionalconsulta.grid.admin" data-page-size="8" data-detail-page="institucionalcadastro.admin"></div>

		<c:if test="${usuario.perfil.permissaoInstitucionalAlt eq 'S'}">
