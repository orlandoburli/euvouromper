...
<div class="panel panel-default panel-body">
	...
	<div class="panel-body">
		<div class="DataGridConsulta" data-page="videoyoutubeconsulta.grid.admin" data-page-size="8" data-detail-page="videoyoutubecadastro.admin"></div>

		<c:if test="${usuario.perfil.permissaoVideoYoutubeAlt eq 'S'}">
