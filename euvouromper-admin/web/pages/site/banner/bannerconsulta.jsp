...
<div class="panel panel-default panel-body">
	...
	<div class="panel-body">
		<div class="DataGridConsulta" data-page="bannerconsulta.grid.admin" data-page-size="8" data-detail-page="bannercadastro.admin"></div>

		<c:if test="${usuario.perfil.permissaoBannerAlt eq 'S'}">
