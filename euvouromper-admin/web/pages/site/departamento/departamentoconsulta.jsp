...
<div class="panel panel-default panel-body">
	...
	<div class="panel-body">
		<div class="DataGridConsulta" data-page="departamentoconsulta.grid.admin" data-page-size="8" data-detail-page="departamentocadastro.admin"></div>

		<c:if test="${usuario.perfil.permissaoDepartamentoAlt eq 'S'}">
