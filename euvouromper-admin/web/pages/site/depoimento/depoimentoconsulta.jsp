...
<div class="panel panel-default panel-body">
	...
	<div class="panel-body">
		<div class="DataGridConsulta" data-page="depoimentoconsulta.grid.admin" data-page-size="8" data-detail-page="depoimentocadastro.admin"></div>

		<c:if test="${usuario.perfil.permissaoDepoimentoAlt eq 'S'}">
