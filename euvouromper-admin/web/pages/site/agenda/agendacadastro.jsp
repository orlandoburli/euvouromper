...
<div class="panel panel-body">
	<form class="form-horizontal" action="#" role="form">
		<div class="FormularioCadastro FormularioGeral panel panel-default form-group" data-page-consulta="agendaconsulta.admin" data-page-operacao="${operacao}" data-page-cadastro="agendacadastro.admin">
			<div class="panel-body">
				<div class="form-group">
					<label class="col-sm-2 control-label text-right">C&oacute;digo</label>
					<div class="col-sm-7">
						<input id="idAgenda" type="text" disabled="disabled" class="form-control" value="${vo.idAgenda }" />
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<select id="status" class="select2" data-field-value="${vo.status}">
							<c:forEach var="tipo" items="${statusAgendaList}">
