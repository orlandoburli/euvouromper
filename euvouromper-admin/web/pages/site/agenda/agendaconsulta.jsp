...
<div class="panel panel-default panel-body">
	...
	<div class="panel-body">
		<div class="DataGridConsulta" data-page="agendaconsulta.grid.admin" data-page-size="8" data-detail-page="agendacadastro.admin"></div>

		<c:if test="${usuario.perfil.permissaoAgendaAlt eq 'S'}">
