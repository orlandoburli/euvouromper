...
<div class="panel panel-body">
	<form class="form-horizontal" action="#" role="form">
		<div class="FormularioCadastro FormularioGeral panel panel-default form-group" data-page-consulta="perfiladminconsulta.admin" data-page-operacao="${operacao}" data-page-cadastro="perfiladmincadastro.admin">
			...
			<!-- ADMINISTRACAO -->
			<div class="col-md-12" id="grupoAdministracao">
			...
			<!-- CADASTROS  -->
			<div class="col-md-12" id="grupoCadastros">
				<div class="panel panel-default">
					<div class="panel-heading">
						<h6 class="panel-title">
			...
			<!-- SITE -->
			<div class="col-md-12" id="grupoSite">
				<div class="panel panel-default">
					<div class="panel-heading">
						<h6 class="panel-title">
			...
			<!-- ONLINE -->
			<div class="col-md-12" id="grupoOnline">
				<div class="panel panel-default">
					<div class="panel-heading">
						<h6 class="panel-title">
			...
			<!-- E-COMMERCE  -->
			<div class="col-md-12" id="grupoEcommerce">
				<div class="panel panel-default">
					<div class="panel-heading">
						<h6 class="panel-title">
