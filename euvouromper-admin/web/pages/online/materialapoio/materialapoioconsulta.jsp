...
<div class="panel panel-default panel-body">
	<div class="panel form-group">
		...
		<div class="col-sm-2">
			<select id="ParametroPesquisa" class="select">
				...
				<option value="Modulo">Nome do Módulo</option>
	...
	<div class="panel-body">
		<div class="DataGridConsulta" data-page="materialapoioconsulta.grid.admin" data-page-size="8" data-detail-page="materialapoiocadastro.admin"></div>
	</div>

	<c:if test="${usuario.perfil.permissaoMaterialApoioAlt eq 'S'}">
